...
# groupid Keyword
wget -d -O API-TEST-groupid-granuleid-valid.json "https://api-test.asf.alaska.edu/services/search/param?groupid=S1A_IWDV_0382_0387_019686_014&output=json"
...
wget -d -O API-TEST-platform-SB-download-valid.download "https://api-test.asf.alaska.edu/services/search/param?platform=SB&maxresults=2000&output=download"
